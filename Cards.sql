...
END;$$;CREATE TABLE IF NOT EXISTS public."Cards2"
(
...
(
	...
	"Current set price" integer NOT NULL,
...
INSERT INTO "FindInShops2" ("id", "Set Name", "Shop Name", "Original set price", "Current discount")
...
DECLARE
	temp integer;
BEGIN
	temp = OLD."Original set price";
	SELECT temp - (OLD."Current discount" * temp / 100) AS temp2;
	NEW."Current set price" = temp2; 
   	RETURN NEW;
END;
$$ language 'plpgsql';

DROP TRIGGER IF EXISTS added_card on "Cards2";

CREATE TRIGGER added_card AFTER INSERT
    ON "Cards2" FOR EACH ROW EXECUTE PROCEDURE 
    count_discount();
