...
(
    ...
    "Official image" character varying(100),
...
CREATE OR REPLACE FUNCTION create_link(IN url character varying(100))
RETURNS TRIGGER AS $$
BEGIN
   	IF url == "NULL" THEN
   		NEW."Official image" = 'https://gatherer.wizards.com/Handlers/Image.ashx?multiverseid=131806&type=card';
	ELSE
		NEW."Official image" = url;
	END IF;
   	RETURN NEW;
END;
$$ language 'plpgsql';

DROP TRIGGER IF EXISTS added_card on "Orders";
